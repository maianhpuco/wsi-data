...
class WholeSlideImage(object):
    ...
    #         print("No valid coordinates generated for contour")
    #         return {}, {}
    #     print(f"Generated {len(coord_candidates)} coordinate candidates")

    #     # Validate contour_holes
    #     if not all(isinstance(hole, np.ndarray) and hole.shape[-1] == 2 for hole in contour_holes):
    #         print(f"Invalid contour_holes: {contour_holes}")
    #         return {}, {}
    ...
    #         result = WholeSlideImage.process_coord_candidate(*args)
